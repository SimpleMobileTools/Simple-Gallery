...
class VideoFragment : ViewPagerFragment(), TextureView.SurfaceTextureListener, SeekBar.OnSeekBarChangeListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if (!mIsPanorama) {
            ...
            mView.apply {
                mBrightnessSideScroll.initialize(requireActivity(), slide_info, true, container, singleTap = { x, y ->
                    if (mConfig.allowInstantChange) {
                ...
                mVolumeSideScroll.initialize(requireActivity(), slide_info, false, container, singleTap = { x, y ->
                    if (mConfig.allowInstantChange) {
